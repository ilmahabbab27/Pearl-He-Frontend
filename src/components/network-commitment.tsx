...
export default function NetworkCommitment() {
  return (
    <section className="commitment-section bg-white px-6 pb-10 pt-14 text-[#003763]" aria-labelledby="network-commitment-title">
      <div className="mx-auto max-w-[1232px]">
        ...
        <div className="commitment-root">
          <p className="mb-2 text-center text-lg font-light">Our commitment is to deliver projects with</p>
          <p className="mb-2 text-center text-xl uppercase leading-relaxed text-[#00b3e7]">Independence, transparency and<br />professional excellence.</p>
          <div className="commitment-brand">
            <img src={logo} alt="" className="h-8 w-8 brightness-0 invert" />
            <div><p>PEARL HERITANCE (PVT) LTD</p><span>BRIDGING VISION AND DEVELOPMENT</span></div>
          </div>
          <h3 className="commitment-management rounded-md border border-[#bfc0c4] px-3 py-2 text-center text-lg font-light">Project Planning &amp; Management</h3>
        </div>
        </div>
        <div className="commitment-branches">
          {groups.map(group => (
            <div key={group.title} className="commitment-branch">
              <div className="mb-2 flex h-11 w-11 items-center justify-center rounded-full border border-[#00b3e7] text-[#a8aaae]"><group.icon className="h-7 w-7" strokeWidth={1} aria-hidden="true" /></div>
        ...
        <div className="mx-auto mt-3 flex max-w-[1040px] items-center gap-3 rounded-md border border-[#bfc0c4] bg-[#eeeff0] px-3 py-2">
